...
const Sidebar = () => {
  return (
    <aside 
      ...
      className="group fixed left-0 top-[80px] h-[calc(100vh-58px)] bg-[#0d0f14]/95 backdrop-blur-md border-r border-white/10 transition-all duration-300 ease-in-out z-50 flex flex-col w-[68px] hover:w-[250px] px-2 hover:px-3 overflow-hidden"
    >
      ...
      <div className="mt-auto mb-4">
        <div className="bg-[#1e2330] border border-white/10 rounded-xl p-2 group-hover:p-3 transition-all duration-300 flex items-center">
          ...
          <div className="w-0 opacity-0 overflow-hidden transition-all duration-300 group-hover:w-auto group-hover:opacity-100 group-hover:ml-3">
            <div className="text-[13px] font-bold text-white whitespace-nowrap">Raj Kumar</div>
            <div className="text-[11px] text-[#8b92a8]">@rajkumar</div>
          </div>
        </div>
      </div>
    </aside>
