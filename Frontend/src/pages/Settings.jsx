...
function Settings() {
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      ...
      await axios.put(`${import.meta.env.VITE_BACKEND_URL || 'http://localhost:5000'}/api/users/change-password`, 
  ...
  const handleDeleteAccount = async (e) => {
    ...
    try {
      ...
      await axios.delete(`${import.meta.env.VITE_BACKEND_URL || 'http://localhost:5000'}/api/users/delete-account`, {
        headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
      });
      // Logout and redirect
      logout();
