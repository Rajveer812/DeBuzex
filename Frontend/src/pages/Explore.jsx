  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const postsRes = await axios.get(`${import.meta.env.VITE_BACKEND_URL || 'http://localhost:5000'}/api/post`);
        ...
        const rankRes = await axios.get(`${import.meta.env.VITE_BACKEND_URL || 'http://localhost:5000'}/api/users/leaderboard`, { headers });
